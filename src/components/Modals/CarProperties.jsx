...
import { addCarProperty, deleteCarProperty, updateCarProperty } from "../../services/features/orderSlice/orderSlice";
...
function CarProperties({ isOpen, setIsOpen, item, index: itemIndex }) {
  ...
  const deletePropertyFunc = ({ index, propertyIndex }) => {
    if (order.carItem[index].properties.length > 1) {
      dispatch(
        deleteCarProperty({
          index,
          propertyIndex,
                      ...
                      onChange={
                        (e) => dispatch(
                          updateCarProperty({
                            ...
                            updatedProperty: {
                              name: e.target.value,
                              description: order.carItem[0].properties[property].description,
                            },
                          })
                        )
                      }
                      ...
                      onChange={(e) =>
                        dispatch(
                          updateCarProperty({
                            ...
                            propertyIndex,
                            updatedProperty: {
                              name: order.carItem[0].properties[property].name,
